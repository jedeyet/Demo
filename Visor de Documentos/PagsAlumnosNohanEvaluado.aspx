<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PagsAlumnosNohanEvaluado.aspx.cs" Inherits="Visor_de_Documentos.PagsAlumnosNohanEvaluado" %>
        ...
        <div class="card mb-6 text-center">
            <div class="card-body">
                ...
                <div class="text-start">
                    ...
                    <br />
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Todos" class="btn btn-success mb-1" Width="113px" />
                    &nbsp;<asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="PorCarrera" class="btn btn-success mb-1" Width="113px" />
