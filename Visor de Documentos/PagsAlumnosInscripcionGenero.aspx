<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PagsAlumnosInscripcionGenero.aspx.cs" Inherits="Visor_de_Documentos.PagsAlumnosInscripcionGenero" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        <form id="form1" runat="server">
             <div class="card mb-6 text-center">
                <div class="card-body">
                    <h5 class="card-title mb-3">Alumnos inscritos por Sede, año, semestre y género</h5>   <div class="text-start">   
        ...
        <br />
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Ver alumnos inscritos" class="btn btn-success mb-1" />
