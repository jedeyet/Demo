<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PagsAlumnosPromedios.aspx.cs" Inherits="Visor_de_Documentos.PagsAlumnosPromedios" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <form id="form278" runat="server">
        ...
        <div class="card mb-6 text-center">
            <div class="card-body">
                <h5 class="card-title mb-3">Mejores promedios por carrera </h5>
                <div class="text-start">
                    ...
                    <br />
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Ver Promedios" class="btn btn-success mb-1" Width="132px" />
                    &nbsp;&nbsp; <asp:Button ID="btNuevo" runat="server" Text="Nuevo" Width="128px" class="btn btn-danger mb-1" OnClick="btNuevo_Click" Height="41px" />
