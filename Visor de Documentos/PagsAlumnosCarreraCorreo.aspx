<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PagsAlumnosCarreraCorreo.aspx.cs" Inherits="Visor_de_Documentos.PagsAlumnosCarreraCorreo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <form id="form278" runat="server">
        ...
        <div class="card mb-6 text-center">
            <div class="card-body">
                <h5 class="card-title mb-3">Correos institucionales de estudiantes por Carrera</h5>
                <div class="text-start">
                    ...
                    <br />
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Ver alumnos" class="btn btn-dark mb-1" />
                    &nbsp;<asp:Button ID="btNuevo" runat="server" Text="Nuevo" Width="113px" class="btn btn-danger mb-1" OnClick="btNuevo_Click" Height="41px" />
       
                    <br />
                    <br />
                    
                    <asp:Label ID="lbResultado" runat="server"></asp:Label> &nbsp;<asp:ImageButton ID="imgbutExc" runat="server"  ImageUrl="~/Imagenes/excel2.jpg" OnClick="imgbutExc_Click" ToolTip="Traslada a Excel los resultados del filtro" Visible="False" class ="btn btn-icon btn-icon-end btn-tertiary mb-1"/>                        
                    <p>
                    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="," class="btn btn-dark mb-1" Visible="false"/>
                    <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text=";" class="btn btn-dark mb-1" Visible="false"/>
                    
                    <asp:TextBox ID="TextBox1" runat="server" Height="114px" TextMode="MultiLine" Width="709px" Visible="False"></asp:TextBox> <p>

                    <p>
                    <asp:GridView ID="GridView1" runat="server" HorizontalAlign="Center" class="table table-striped">
                    </asp:GridView>
                    <p>
                    <asp:TextBox ID="TextBox2" runat="server" Height="80px" TextMode="MultiLine" Visible="False" Width="709px"></asp:TextBox>
                    </p>
                    <p>
                    <asp:TextBox ID="TextBox3" runat="server" Height="80px" TextMode="MultiLine" Visible="False" Width="709px"></asp:TextBox>
                    </p>
                </div>
            </div>
