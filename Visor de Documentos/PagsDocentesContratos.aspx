<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PagsDocentesContratos.aspx.cs" Inherits="Visor_de_Documentos.PagsDocentesContratos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeaderC" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <form id="form32A1" runat="server">
                ...
                <div class="card-body">
                    <h5 class="card-title mb-3">Docentes por sede y facultad</h5>                            
                        <div class="text-start">
                            ...
                            <br />
                            <br />
                            <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Ya Firmaron" class="btn btn-success mb-1" Width="132px"/>                                              
                            &nbsp;
                            <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="No han Firmado" class="btn btn-danger mb-1" Width="140px"/>                                              
                            ...
                            &nbsp;<asp:Button ID="btNuevo" runat="server" Text="Nuevo" Width="113px" class="btn btn-success mb-1" OnClick="btNuevo_Click" Height="41px" />
