<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PagsDocentesSede.aspx.cs" Inherits="Visor_de_Documentos.PagsDocentesSede" %>
                ...
                <div class="card-body">
                    <h5 class="card-title mb-3">Docentes por sede y facultad</h5>                            
                        <div class="text-start">                          
                            ...
                            <br />
                            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Ver Docentes activos" class="btn btn-dark mb-1" Width="249px"  />                         
                            <br />
                            <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Ver Docentes de tiempo completo" class="btn btn-success mb-1" Width="251px"/>                        
                            <br />
