<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PagsDocentesPrivadosPorArea.aspx.cs" Inherits="Visor_de_Documentos.PagsDocentesPrivadosPorArea" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <form id="form278" runat="server">
        ...
        <asp:Label ID="Label4" runat="server" Text="Carrera"></asp:Label>
                            <asp:DropDownList ID="ddCarrera" runat="server" class ="btn btn-outline-success dropdown-toggle mb-1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true"  Width="500" OnSelectedIndexChanged="ddCarrera_SelectedIndexChanged">
        </asp:DropDownList>
        <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Proceder" class="btn btn-success mb-1" Width="188px"  />
                            <br />
        <asp:Label ID="Label6" runat="server" Text="Área" Visible="False"></asp:Label>
                            &nbsp;&nbsp;&nbsp;
                            <asp:DropDownList ID="ddArea" runat="server" class ="btn btn-outline-success dropdown-toggle mb-1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true"  Width="500" OnSelectedIndexChanged="ddCarrera_SelectedIndexChanged" Visible="False">
        </asp:DropDownList>
        <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="Ver por área" class="btn btn-success mb-1" Width="188px" Visible="False"  />
                            <br />
        ...
        <asp:Label ID="lbResultado" runat="server"></asp:Label>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="true" HorizontalAlign="Center" class="table table-striped">
