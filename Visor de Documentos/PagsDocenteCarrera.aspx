<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PagsDocenteCarrera.aspx.cs" Inherits="Visor_de_Documentos.PagsDocenteCarrera" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <form id="form278" runat="server">
        ...
        <div class="card mb-6 text-center">
            <div class="card-body">
                <h5 class="card-title mb-3">Docentes por sede y carrera</h5>
                <div class="text-start">
                    ...
                    <br />
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Ver Docentes" class="btn btn-dark mb-1" />
