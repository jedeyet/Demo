<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PagsDocentesActivo.aspx.cs" Inherits="Visor_de_Documentos.PagsDocentesActivo" %>
...
<script runat="server">
    ...
    <form id="form278" runat="server">
        <div class="card mb-6 text-center">
            ...
            <div class="card-body">
                    <h5 class="card-title mb-3">Docentes activos e inactivos por Sede y Carrera</h5>                            
        ...
        <asp:Label ID="Label5" runat="server" Text="Semestre" Visible="False"></asp:Label>
        <asp:DropDownList ID="ddSem" runat="server" class ="btn btn-outline-success dropdown-toggle mb-1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true" Visible="False" >
        </asp:DropDownList>
        <br />
        &nbsp;<br />
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" class="btn btn-dark mb-1" Text="Ver Docentes"  Width="188px"  />
        &nbsp; 
        <br />
        <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Ver Docentes activos" class="btn btn-success mb-1" Width="188px"  />
        &nbsp;<asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="Ver Docentes inactivos" class="btn btn-success mb-1" Width="188px"  />
        ...
        <asp:GridView ID="GridView1" runat="server" HorizontalAlign  ="Center" class="table table-striped"
            autogenerateselectbutton="True" selectedindex="1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" >
        </asp:GridView>
        </div></div></div>
    </form>
