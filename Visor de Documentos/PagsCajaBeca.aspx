<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PagsCajaBeca.aspx.cs" Inherits="Visor_de_Documentos.PagsCajaBeca" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <form id="form1" runat="server">
            <div class="card mb-6 text-center">
                <div class="card-body">
                    <h5 class="card-title mb-3">Reportes de Becas</h5>
    ...
    <asp:TextBox ID="txAnio" runat="server" CssClass="form-control" MaxLength="11" Width="155px"></asp:TextBox>                            
                            <asp:Label ID="Label3" runat="server" Text="Ciclo"></asp:Label>
                            
                            <br />
                             <div class="form-check">
                                 <asp:RadioButtonList ID="RadioButtonListCiclo" name="basicValidationRadioButton" runat="server" RepeatDirection="Horizontal" class ="btn btn-outline-success  mb-1">
                            </asp:RadioButtonList>                                                          
                          </div>
