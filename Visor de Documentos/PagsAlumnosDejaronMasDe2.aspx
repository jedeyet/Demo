<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PagsAlumnosDejaronMasDe2.aspx.cs" Inherits="Visor_de_Documentos.PagsAlumnosDejaronMasDe2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            <form id="form278" runat="server">
                ...
                <div class="card-body">
                    <h5 class="card-title mb-3">Alumnos con dos o más cursos perdidos</h5>   <div class="text-start">   
        
                <br />
        <asp:Label ID="Label1" runat="server" Text="Sede"></asp:Label>
        <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" Font-Bold="True" ForeColor="#CCFFFF" class ="btn btn-outline-success dropdown-toggle mb-1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true" >
        ...
        &nbsp;<asp:DropDownList ID="ddCarrera" runat="server" CssClass="bg-green-dark" Width="500" AutoPostBack="True" OnSelectedIndexChanged="ddCarrera_SelectedIndexChanged">
        </asp:DropDownList>
        <br />
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Por Carrera" class="btn btn-success mb-1" Width="188px"  />
        &nbsp;
        <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Por Sede" class="btn btn-success mb-1" Width="188px"  />
        ...
        <asp:GridView ID="GridView1" runat="server" HorizontalAlign="Center" Visible="False" class="table table-striped" >
