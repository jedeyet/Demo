<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="pagsAlumnosInscritos.aspx.cs" Inherits="Visor_de_Documentos.pagsAlumnosInscritos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <form id="form1" runat="server">
        <div class="card mb-6 text-center">
                <div class="card-body">
                    <h5 class="card-title mb-3">Alumnos inscritos por Sede, año y semestre</h5>   <div class="text-start">   
